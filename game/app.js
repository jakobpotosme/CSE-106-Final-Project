// DOM Elements
const allCells = document.querySelectorAll('.cell:not(.row-top)'); // select all the
//cells but not top row
const topCells = document.querySelectorAll('.cell.row-top'); //all the top cells
